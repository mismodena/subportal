<div class="form">
    ...
    Yii::app()->clientScript->registerScript('JQuery', "      
        ...
        $('#BQClaim_claimType2').live('change', function(){
            updateTotal()
        });           
        ...
        $('#BQClaim_idCust').change(function() { 
            ...
            $.get(url, { dealerID: dealerID.trim(), branchID: branchID.trim() } )
                .done(function(data) {
        ...
        function calcFooter(){
            ...
            var clType = $('#BQClaim_claimType2').val();
            
            var multiplyValue = 0.7;
            if(clType == 'ftu' || clType == 'dummy'){
                multiplyValue = 1;
            }
            ...
            if(total > 0){
                ...
                bqUsed = total - tqUsed;
                //check = bqUsed + tqUsed;
                bqUsed = bqUsed / multiplyValue ;
                if(bqUsed > bqAvail)  bqUsed = 0;//bqUsed = bqAvail;  
            }      
    ...
    <div>
        <table>
            ...
            <tr>               
                <td valign="top">
                    <div class="simple">
                        <?php echo $form->labelEx($model, 'claimType2'); ?>
                        <?php
                        $this->widget('ext.widgets.select2.XSelect2', array(
                            'model' => $model,
                            'attribute' => 'claimType2',
                            'data' => array("non"=>"Non-Barang","ftu"=>"FTU", "dummy" => "Faktur Dummy"),
                            'htmlOptions' => array(
                                'style' => 'width:295px',
                                'empty' => '',
                        ...
                        ?>
                        <?php echo $form->error($model, 'claimType2'); ?>
                    </div>                               
                </td>      
                <td >
                    <div class="simple">
            ...
            <tr>
                ...
                <td>            
                    <div class="simple">
                        ...
                        <?php echo $form->fileField($model,'attachment',array('size'=>50,'maxlength'=>50, )); ?>
