            ...
            <table width="100%" border="0">   
               <tr>
                   ...
                   <td width="18%" style="text-align: right">
                       <strong id="subTotal"><?php echo "Rp. ". number_format($model->fppLimit); ?></strong>
                   </td>
               </tr>  
               <tr>
                   <td style="text-align: right">
                   ...
                   <td width="18%" style="text-align: right">
                       <strong id="subTotal"><?php echo "Rp. ". number_format($model->fppSaldo); ?></strong>
                   </td>
               </tr>  
               <tr>
                   <td style="text-align: right">
                   ...
                   <td width="18%" style="text-align: right">
                       <strong id="subTotal"><?php echo "Rp. ". number_format($model->fppCash); ?></strong>
                   </td>
               </tr>  
               <tr>
                <td style="text-align: right">
                    <strong>Bon Gantung</strong>
                </td>
                <td width="18%" style="text-align: right">
                    <strong id="subTotal"><?php echo "Rp. ". number_format($model->fppOutstanding); ?></strong>
                </td>
            </tr>  
               <tr>
                   <td style="text-align: right">
               ...
               <?php if($model->adjType !== "+-")
               {
                echo '<tr>
                   <td style="text-align: right">
                       <strong>Koreksi ('.$model->adjustmentType.')</strong>
                   </td>
                   <td width="18%" style="text-align: right">
                       <strong id="subTotal"> Rp. '. number_format($model->adjValue).'</strong>
                   </td>
               </tr>  ';
                echo '<tr>
                   <td style="text-align: right">
                       <strong>Setelah Koreksi </strong>
                   </td>
                   <td width="18%" style="text-align: right">
                       <strong id="subTotal"> Rp. '. number_format($model->adjustmentValue).'</strong>
                   </td>
               </tr>  ';
	...
	<tr>
		<td>
			<table width="100%" border="1">
				...
				<tr align="center">
					<td>Dibuat Oleh,<br/><br/><?php echo date("d-m-Y", strtotime($approval['userDate'])); ?><br/><?php echo $approval['userName']; ?></td>
					<td><p class="boks">SIGNED</p><?php echo date("d-m-Y", strtotime($approval['deptHeadDate'])); ?><br/><?php echo $approval['deptHeadName']; ?></td>
                                        <?php
