<div class="form">
    ...
    Yii::app()->clientScript->registerScript('JQuery', "        
        ...
        function calcTotal()
        {
            ...
            $('#DocumentRequest_revValue').val(formatNumber(sum, 0,',','','','','-',''));    
            $('#DocumentRequest_revCount').val(formatNumber(count, 0,',','','','','-',''));
        }
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <?php 
            $this->widget('ext.widgets.tabularinput.XTabularInput', array(
                ...
                'inputTagName' => 'tr',
                'inputView' => '/site/extensions/_tabularRevDetail',
                'inputUrl' => $this->createUrl('request/addTabRevDetail'),
        ...
        <div>            
            <table>               
                ...
                <tr>
                    ...
                    <td>
                        <div class="simple">
                            ...
                            <?php echo $form->textField($model, 'fmt2Amount', array('size' => 15, 'maxlength' => 15,"style"=>"text-align: right", 'readonly' => true)); ?>
                ...
                <tr>
                    <td>
                        <div class="simple">
                            <?php echo $form->labelEx($model, 'revCount'); ?>
                            <?php echo $form->textField($model, 'revCount', array('size' => 5, 'maxlength' => 15,'readonly' => true, "style"=>"text-align: right")); ?>
                            <?php echo $form->error($model, 'revCount'); ?>
                        </div>                               
                    </td>
                    <td>
                        <div class="simple">
                            <?php echo $form->labelEx($model, 'revValue'); ?>
                            <?php echo $form->textField($model, 'revValue', array('size' => 15, 'maxlength' => 15,"style"=>"text-align: right", 'readonly' => true)); ?>
                            <?php echo $form->error($model, 'revValue'); ?>
                        </div>                               
                    </td>                      
                </tr>
                <tr>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Simpan' : 'Simpan',array('confirm'=>'Submit verifikasi?'));?>
